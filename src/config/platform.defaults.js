/**
 * سیاست محیط اجرا — مستقل از UI و قابل استفاده در هر لایه.
 * web: PWA و APIهای مرورگر
 * native: Capacitor (بدون SW / بنر نصب / آپدیت PWA)
 */
...
export function resolvePlatformPolicy(isNative) {
  return isNative ? { ...nativePlatformPolicy, pwa: { ...nativePlatformPolicy.pwa } } : { ...webPlatformPolicy, pwa: { ...webPlatformPolicy.pwa } }
}
